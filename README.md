...
포어메세지 서비스 관련 문의사항이 있으시면 언제든지 포어메세지 github(https://github.com/ForeMessage/ForeMessage_official.git) 혹은 이메일(ioskooma@gmail.com )로 연락해 주시기 바랍니다.
...
다. 기타 개인정보에 관한 상담이 필요한 경우에는 개인정보침해신고센터, 경찰청 사이버테러 대응센터로 문의하실 수 있습니다.
